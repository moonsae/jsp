 ...
 * Generated at: 2023-09-08 01:28:22 UTC
...
public final class el2_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<h2> 저장소</h2>\r\n");
      out.write("<ul>\r\n");
      out.write("	<li>pageContext -> pageScope</li>\r\n");
      out.write("	<li>request -> requestScope</li>\r\n");
      out.write("	<li>session -> sessionScope</li>\r\n");
      out.write("	<li>application -> applicaionScope</li>\r\n");
      out.write("</ul>\r\n");
      out.write("\r\n");
      ...
      out.write("<p> 모든 사용자 공유해야 하는 데이터를 저장하는 공간 : 설정 정보, 데이터베이스연결정보</p>\r\n");
      out.write("\r\n");
      out.write("<h3>pageContext</h3>\r\n");
      out.write("<p> jsp페이지 하나당 제공되는 저장소</p>\r\n");
      out.write("<p> jsp페이지 내에서 EL 사용하여 변수를 처리하고 싶을 대 사용한다.</p>\r\n");
      out.write("\r\n");
 ...
 String test = "EL을 사용하고 싶어요"; 
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<h3>test변수를 el을 사용하고 싶다 el은 저장소에 담긴 애들만 쓸 수 있음</h3>\r\n");
      out.write("<h3>EL표현식은 저장소에 저장된 것들만 사용할 수 있다</h3>\r\n");
